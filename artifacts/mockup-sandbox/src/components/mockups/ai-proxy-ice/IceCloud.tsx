      ...
      <div className="mx-auto max-w-[1320px] px-5 pb-20 sm:px-8 lg:px-12">
        <header className="mt-5 flex items-center justify-between rounded-full border border-white/70 bg-white/55 px-5 py-3 shadow-[0_10px_35px_rgba(71,126,150,.08)] backdrop-blur-xl sm:px-7">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="ice-button rounded-full border border-white/75 bg-[#c7e6ec] px-4 py-2.5 text-[11px] font-bold tracking-[-.01em] text-[#426879] shadow-[0_8px_20px_rgba(83,154,176,.1)] hover:bg-[#b8dce5]">Начать бесплатно <ArrowRight className="ml-2 inline" size={13}/></button>
          </div>
        </header>
          ...
          <section id="cloud" className="grid items-center gap-12 pb-20 pt-20 sm:pt-28 lg:grid-cols-[.86fr_1.14fr] lg:gap-16 lg:pb-28">
            <div className="max-w-[590px]">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                <button className="ice-button rounded-full border border-white/75 bg-[#c7e6ec] px-5 py-3.5 text-[13px] font-bold tracking-[-.01em] text-[#426879] shadow-[0_10px_24px_rgba(83,154,176,.12)] hover:bg-[#b8dce5]">Создать API-ключ <ArrowRight className="ml-2 inline" size={15}/></button>
